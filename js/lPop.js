...
function lPop (p,tw,th) {
	//950, 537
	if(tw==undefined) tw = 640//页面宽
	if(th==undefined) th = 1008//页面高
	...
	addCloseStyle(function (time) {
		...
		TweenMax.to(contentGrp,time,{scale:0.8,ease:Power1.easeOut})
		TweenMax.to(pop,time,{autoAlpha:0})
	},"dft")
	
	
	addOpenStyle(function () {
		TweenMax.to(contentGrp,0,{scale:0.8})
		TweenMax.to(pop,0,{autoAlpha:0})
		TweenMax.to(contentGrp,0.6,{autoAlpha:1,scale:1,ease:Elastic.easeOut.config(1, 0.5)})
		TweenMax.to(pop,0.15,{autoAlpha:1})
	},"dft")
	...
	addOpenStyle(function () {
		...
		TweenMax.to(pop,0.2,{autoAlpha:1})
	},"tra")
